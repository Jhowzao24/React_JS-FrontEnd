...
export default function KtorzeF(){
    ...
    return(
        <div style={{width: '800px', height: '1000px', backgroundColor: 'darkblue', margin: '-40px', color: 'white'}}>
            <center>
                ...
                <img style={{width: '200px', float: 'left'}} src='https://aprenderpianocom.files.wordpress.com/2020/07/141e7-09597-negra-con-puntillo.png?w=150&h=150' alt='addimagepoint'/>
                <br/><br/>
                ...
                <Grid style={{float: 'left', paddingLeft: '270px'}} container spacing={30}>
                    {showElement && <Tooltip title='Asyou can to see, this note is equal this sum, a minim + semiminim is like = punctuated minim; So to understand it better, as the minim values two beats and  the semiminim values one beat, summing this two notes with different values we will have one only note with a value like  = 3, it is because summing a note with value 2 and other note with a value 1 we have this number of times in a one note enought'><img style={{width: '130px', height: '70px'}} src='https://th.bing.com/th/id/OIP.ffYFnofPT4EsthNU1Zv2dQAAAA?pid=ImgDet&rs=1' alt='ell'/></Tooltip>}
                </Grid>
                <Grid style={{float: 'left', paddingLeft: '50px'}} container spacing={5}>
                    {showOelement && <Tooltip title='As you can to see here, we have this two forms to sum this notes to become a one unik note with all the values contented in each note'><img style={{width: '170px', height: '70px'}} src='https://th.bing.com/th/id/R.04dea2a7b7baa69844ddb8c4c6a9cbc0?rik=hGDO8TdnKGtykQ&pid=ImgRaw&r=0' alt='elleme'/></Tooltip>}
                </Grid>
                ...
                <Grid style={{float: 'left', paddingLeft: '830px'}} container spacing={20}>
                    <p style={{color: 'white', fontSize: '50px'}}>.</p>
                </Grid>
