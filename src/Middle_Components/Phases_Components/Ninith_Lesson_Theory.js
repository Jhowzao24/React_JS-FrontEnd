import { ButtonBase, Divider, Grid, Tooltip } from '@mui/material';
...
export default function NonoFase(){
    const HomemBar = [
        <div style={{width: '400px', backgroundColor: 'Highlight'}}>
            ...
            <img style={{width: '350px', height: '85px'}} src='https://4.bp.blogspot.com/-Uqd-Gqy1_68/VVUI31HYLVI/AAAAAAAAALw/4q3RIFbU8sw/s1600/Melodia%2Bcom%2Bcasa%2Bde%2B1%C2%AA%2Be%2B2[%2Bvez%2Bcom%2Britornello-%2Bn%C2%BA%2Bcompassos%2Bescritos%2Btocados.jpg' alt='casaritornelo'/>
        </div>
    ]
    const rittor = [
        <div style={{width: '400px', backgroundColor: 'dodgerblue', margin: '20px'}}>
            ...
            <img style={{width: '370px', height: '150px'}} src='https://3.bp.blogspot.com/-RZeFN_LJy1Q/T11Tfl8GGqI/AAAAAAAAALA/uL96aDgiHA8/s1600/Ritornello.jpg' alt='begBar'/>
    ...
    const barRit = [
        <div style={{margin: '-30px', backgroundColor: 'blue'}}>
            ...
            <img style={{width: '400px'}} src='https://4.bp.blogspot.com/-Uqd-Gqy1_68/VVUI31HYLVI/AAAAAAAAALw/4q3RIFbU8sw/s1600/Melodia%2Bcom%2Bcasa%2Bde%2B1%C2%AA%2Be%2B2[%2Bvez%2Bcom%2Britornello-%2Bn%C2%BA%2Bcompassos%2Bescritos%2Btocados.jpg' alt='rit3'/>
        </div>
    ]
    return(
        <div style={{width: '500px', height: '400px', backgroundColor: 'blueviolet', borderRadius: '30px'}}>
